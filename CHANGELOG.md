...
* Support for [extended clientside aggregation](https://github.com/DataDog/datadog-go/v5/blob/master/README.md#client-side-aggregation). Thanks, [praboud-stripe](https://github.com/praboud-stripe)!
